...
type updateUser = Omit<InterfaceCreateUser, "name" | "password">;
...
export class QueryAuth {
  ...
  updateUserData({ name, email }: updateUser & { name: string | undefined }) {
    return this.db
      .prepare(
        /*SQL */ `
